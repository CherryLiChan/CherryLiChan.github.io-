...
layout: post
title: "头像效果"
date: 2018-01-03 18:15:06 
description: "制作本网页中, 翻页的效果"
tag: 搭建博客那些事儿
---


### 头像效果
![头像效果动图](/images/posts/Effect_headportrait//2018-01-04_04-16-04.gif)

如果你想要我博客里的头像效果，你只需要拿 CherryLiChan.github.io/_includes/side-panel.html 文件里面 `头像效果` 和 CherryLiChan.github.ioo/css/main.css 里面最后面 `头像效果` 部分就行了。
...
转载请注明：[黎婵的博客](https://cherrylichan.github.io) » [点击阅读原文](https://cherrylichan.github.io/2017/01/头像效果/)